...
public class EspTouchActivity extends EspTouchActivityAbs {
    public static final String TAG = EspTouchActivity.class.getSimpleName();

    public static final int REQUEST_PERMISSION = 0x01;

    public EsptouchAsyncTask4 mTask;

    // public ActivityEsptouchBinding mBinding;

    public String mSsid;
    public byte[] mSsidBytes;
    ...
    public static class EsptouchAsyncTask4 extends AsyncTask<byte[], IEsptouchResult, List<IEsptouchResult>> {
        public final WeakReference<EspTouchActivity> mActivity;
